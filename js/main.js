(function ($) {
	...
	// const accordionOneTrigger = document.querySelectorAll('.accordion-one .accordion-button');

	// accordionOneTrigger.forEach(button => {
	...
	// 			document.querySelectorAll('.accordion-one .accordion-item').forEach(item => {
